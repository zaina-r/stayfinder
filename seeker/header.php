...
<header>
        ...
        <div class="user-info">
            ...
            <?php else: ?>
                <div class="user-profile">
                    <a href="seeker-profile.php"><img src="../uploads/profile-pic/<?php echo htmlspecialchars($profilePic); ?>" alt="User Profile Picture"></a>
                    <span onclick="toggleDropdown()">Hi, <?php echo htmlspecialchars($firstName); ?> &nbsp<i class='fas fa-angle-double-down'></i></span>
                </div>
                <div id="dropdown" class="dropdown">
                    <a class="dropdown-top-2" href="seeker-profile.php">View My Profile</a>
    ...
    <div class="serch-bar-div">
        <!-- Search Bar -->
        <form class="search-bar" action="viewads.php" method="GET">
