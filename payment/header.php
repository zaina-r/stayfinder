...
<header>
    <div class="navbar">
        ...
        <div class="user-info">
        <button onclick="window.location.href='../advertiser/postad.php'" class="head-button" type="button"><span class="span-class"></span>POST AD</button>
            
                <div class="user-profile">
                    <a href="../advertiser/dashboard.php"><img src="../uploads/profile-pic/<?php echo htmlspecialchars($profilePic); ?>" alt="User Profile Picture"></a>
